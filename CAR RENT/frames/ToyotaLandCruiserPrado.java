...
public class ToyotaLandCruiserPrado extends JFrame implements ActionListener
{
	...
	public ToyotaLandCruiserPrado()
	{
		super("Toyota Land Cruiser Prado");
		...
		img = new ImageIcon("C:\\Users\\Asus\\OneDrive\\Documents\\FT Java Project Edited8\\frames\\Pictures\\ToyotaLandCruiserPrado.jpg");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == nextbtn)
		{
		 try
		 {
            FileWriter writer = new FileWriter("CustomerRentalInfo(Toyota).txt");
			BufferedWriter buffer = new BufferedWriter(writer);
			PrintWriter printer = new PrintWriter(buffer);
			printer.println("Selected car model: ");
			printer.println("Toyota Land Cruiser Prado");
		...
		ToyotaPaymentFrame tp=new ToyotaPaymentFrame();
		tp.setVisible(true);
		setVisible(false);
		}
