...
public class NissanSUV extends JFrame implements ActionListener
{
	JLabel selectLabel;
	...
	public NissanSUV()
	{
		...
		String arr[] = {"Nissan Kicks", "Nissan X-Trail", "Nissan Magnite"};
		cb=new JComboBox (arr);
	    cb.setBounds(300,20,110,30);
	    panel.add(cb);
	
	    selectLabel=new JLabel("Select your Nissan SUV model: ");
     ...
     public void actionPerformed(ActionEvent ae)
	{
		...
		{
		if(cb.getSelectedItem().toString().equals("Nissan Kicks"))
		{
			NissanKicks nk = new NissanKicks();
		    nk.setVisible(true);
		    setVisible(false);
		}
		else if(cb.getSelectedItem().toString().equals("Nissan X-Trail"))
		{
			NissanXTrail nxt = new NissanXTrail();
		    nxt.setVisible(true);
		    setVisible(false);
		}
        else if(cb.getSelectedItem().toString().equals("Nissan Magnite"))
		{
