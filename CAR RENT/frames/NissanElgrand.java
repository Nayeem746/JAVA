...
public class NissanElgrand extends JFrame implements ActionListener
{
	...
	public NissanElgrand()
	{
		super("Nissan Elgrand");
		...
		img = new ImageIcon("C:\\Users\\Asus\\OneDrive\\Documents\\FT Java Project Edited8\\frames\\Pictures\\NissanElgrand.jpg");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == nextbtn)
		{
		 try
		 {
            FileWriter writer = new FileWriter("CustomerRentalInfo(Nissan).txt");
			BufferedWriter buffer = new BufferedWriter(writer);
			PrintWriter printer = new PrintWriter(buffer);
			printer.println("Selected car model: ");
			printer.println("Nissan Elgrand");
		...
		NissanPaymentFrame np=new NissanPaymentFrame();
		np.setVisible(true);
		setVisible(false);
		}
