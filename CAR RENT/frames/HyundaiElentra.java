...
public class HyundaiElentra extends JFrame implements ActionListener
{
	...
	public HyundaiElentra()
	{
		super("Hyundai Elentra");
		...
		img = new ImageIcon("C:\\Users\\Asus\\OneDrive\\Documents\\FT Java Project Edited8\\frames\\Pictures\\HyundaiElentra.jpg");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == nextbtn)
		{
		 try
		 {
			...
			printer.println("Hyundai Elentra");
		...
		{	
		HyundaiSedan hs=new HyundaiSedan();
		hs.setVisible(true);
		setVisible(false);
	    }
	}
