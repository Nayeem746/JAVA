...
public class ToyotaCorolla extends JFrame implements ActionListener
{
	...
	public ToyotaCorolla()
	{
		...
		img = new ImageIcon("C:\\Users\\Asus\\OneDrive\\Documents\\FT Java Project Edited8\\frames\\Pictures\\ToyotaCorolla.jpg");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == nextbtn)
		{
		 try
		 {
			...
			printer.println("Toyota Corolla");
