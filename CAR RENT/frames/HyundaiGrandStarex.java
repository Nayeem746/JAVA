...
public class HyundaiGrandStarex extends JFrame implements ActionListener
{
	...
	public HyundaiGrandStarex()
	{
		super("Hyundai Grand Starex");
		...
		img = new ImageIcon("C:\\Users\\Asus\\OneDrive\\Documents\\FT Java Project Edited8\\frames\\Pictures\\HyundaiGrandStarex.jpg");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == nextbtn)
		{
		 try
		 {
			...
			printer.println("Hyundai Grand Starex");
		...
		{	
		HyundaiMicro hm=new HyundaiMicro();
		hm.setVisible(true);
		setVisible(false);
	    }
	}
