...
public class HyundaiStaria extends JFrame implements ActionListener
{
	...
	public HyundaiStaria()
	{
		super("Hyundai Staria");
		...
		img = new ImageIcon("C:\\Users\\Asus\\OneDrive\\Documents\\FT Java Project Edited8\\frames\\Pictures\\HyundaiStaria.jpg");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == nextbtn)
		{
		 try
		 {
			...
			printer.println("Hyundai Staria");
