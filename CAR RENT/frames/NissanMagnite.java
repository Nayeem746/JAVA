...
public class NissanMagnite extends JFrame implements ActionListener
{
	...
	public NissanMagnite()
	{
		super("Nissan Magnite");
		...
		img = new ImageIcon("C:\\Users\\Asus\\OneDrive\\Documents\\FT Java Project Edited8\\frames\\Pictures\\NissanMagnite.jpg");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == nextbtn)
		{
		 try
		 {
			...
			printer.println("Nissan Magnite");
