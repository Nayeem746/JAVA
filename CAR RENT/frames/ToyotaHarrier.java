...
public class ToyotaHarrier extends JFrame implements ActionListener
{
	...
	public ToyotaHarrier()
	{
		super("Toyota Harrier");
		...
		img = new ImageIcon("C:\\Users\\Asus\\OneDrive\\Documents\\FT Java Project Edited8\\frames\\Pictures\\ToyotaHarrier.jpg");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == nextbtn)
		{
		 try
		 {
			...
			printer.println("Toyota Harrier");
