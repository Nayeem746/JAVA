...
public class NissanXTrail extends JFrame implements ActionListener
{
	...
	public NissanXTrail()
	{
		...
		img = new ImageIcon("C:\\Users\\Asus\\OneDrive\\Documents\\FT Java Project Edited8\\frames\\Pictures\\NissanXTrail.jpg");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == nextbtn)
		{
		 try
		 {
			...
			printer.println("Nissan X-Trail");
