...
public class NissanSkyline extends JFrame implements ActionListener
{
	...
	public NissanSkyline()
	{
		...
		img = new ImageIcon("C:\\Users\\Asus\\OneDrive\\Documents\\FT Java Project Edited8\\frames\\Pictures\\NissanSkyline.jpg");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource() == nextbtn)
		{
		 try
		 {
			...
			printer.println("Nissan Skyline");
